...
class Blockchain(object):
    def __init__(self):
        self.chain = [] #blockのリスト
        self.current_transactions = [] #transactionsのリスト
        self.new_block(previous_hash=1, proof=100) # ジェネシスブロックを作る
        self.nodes = set()
    ...
    def resolve_conflicts(self):
        """
        これがコンセンサスアルゴリズムだ。ネットワーク上の最も長いチェーンかつ有効なチェーンを自らのチェーンと置き換えることでコンフリクトを解消する。
